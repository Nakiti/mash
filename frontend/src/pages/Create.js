...
const Create = () => {
  ...
  const handleModal = () => {
   ...
   const handleSubmit = async(e) => {
      ...
      try { 
         await axios.post("/mashes/post", {title: title, info: info, timestamp: date, category: category, plays: String(0), access: access, userID: String(userId), question: ques, version: 1})
      } catch (e) {
         console.log(e)
      }
